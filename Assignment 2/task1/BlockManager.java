...
public class BlockManager
{
	...
	public static void main(String[] argv)
	{
		try
		{
			...
			System.out.println("Initial value of top = " + soStack.iTop + "."); // TASK 1: to be able to compile and run since no getITop() method is implemented yet
			...
			System.out.println("Final value of top = " + soStack.iTop + "."); // TASK 1: to be able to compile and run since no getITop() method is implemented yet
			System.out.println("Final value of stack top = " + soStack.pick() + ".");
			System.out.println("Final value of stack top-1 = " + soStack.getAt(soStack.iTop - 1) + "."); // TASK 1: to be able to compile and run since no getITop() method is implemented yet
			System.out.println("Stack access count = " + soStack.accessCounter); // TASK 1: to be able to compile and run since no getAccessCounter() method is implemented yet
			out.close();
			System.exit(0);
		}
		...
		public void run()
		{
			...
			try
			{
				...
				(
					...
					" from position " + (soStack.iTop + 1) + "." // TASK 1: to be able to compile and run since no getITop() method is implemented yet
				);
				...
				(
					...
					soStack.iTop + "." // TASK 1: to be able to compile and run since no getITop() method is implemented yet
				);
	...
	static class ReleaseBlock extends BaseThread
	{
		...
		public void run()
		{
			...
			try
			{
				if(!(soStack.iTop == -1)) // TASK 1: to be able to compile and run since no isEmpty() method is implemented yet
		...
		public void run()
		{
			...
			try
			{
				for(int i = 0; i < siThreadSteps; i++)
				{
					...
					for(int s = 0; s < soStack.iSize; s++) // TASK 1: to be able to compile and run since no getISize() method is implemented yet
						System.out.print
						(
